...
jQuery(document).ready(function () {
    jQuery('#uccs-editor-toggle').click(function (e) {
        e.preventDefault();

        jQuery('i.uccs-fa-toggle').toggleClass('fa-toggle-off');
        jQuery('i.uccs-fa-toggle').toggleClass('fa-toggle-on');

        if (jQuery('.layout-region-node-main').hasClass('uccs-full-width')) {
            jQuery('.layout-region-node-main').removeClass('uccs-full-width');
            jQuery('.layout-region-node-secondary').removeClass('uccs-zero-width');
        }
        else {
            jQuery('.layout-region-node-main').addClass('uccs-full-width');
            jQuery('.layout-region-node-secondary').addClass('uccs-zero-width');
        }
    })
